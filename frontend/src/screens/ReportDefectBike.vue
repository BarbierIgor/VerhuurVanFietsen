    ...
    <div class="p-4">
        ...
        <div class="w-full mt-10 grid gap-8">
            ...
            <div>
                ...
                <CustomSelect :items="['Option 01', 'Option 02', 'Option 03', 'Option 04', 'Option 05', 'Option 06']"></CustomSelect>
            </div>
            ...
            <div>
                ...
                <div class="mt-4">
                    <transition-group name="image-grid" tag="ul" class="transition duration-1000 grid gap-4 grid-cols-4 grid-rows-2" v-if="files.length > 0">
                        ...
                        <label class="relative selected-image flex justify-center items-center rounded-2xl bg-dark-400" key="add" for="images">
