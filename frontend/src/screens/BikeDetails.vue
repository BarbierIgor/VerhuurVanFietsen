...
<template>
    ...
    >
        ...
        <!-- Title -->
        <p class="text-5xl font-semibold text-dark-400 my-4">
            Xioami <br>
            Pro 2
        </p>

        <div class="w-screen -ml-4 grow overflow-hidden">
            <img class="w-full h-full object-contain -translate-x-24 " src="../assets/images/image_step.png" alt="" srcset="">
        </div>
        ...
        >
            ...
            >
                ...
                <svg class="w-6 h-6" viewBox="0 0 28.515 23.959">
                    <g transform="translate(3.536 3.536)">
                        <g>
                            <line x2="11.942" transform="translate(8.444 8.444) rotate(135)" fill="none" stroke="#2e353b" stroke-linecap="round" stroke-width="5"/>
                            <line x2="11.942" transform="translate(8.444 8.444) rotate(-135)" fill="none" stroke="#2e353b" stroke-linecap="round" stroke-width="5"/>
                        </g>
            ...
            <div 
                class="h-full rounded-lg bg-dark-400 flex flex-col justify-evenly py-3 items-center overflow-hidden
                    transition duration-500
                "
            >
                ...
                <p class="text-lg text-dark-900 font-semibold">
                    2h
                </p>

                <p class="text-xl text-dark-600 font-semibold">
                    66%
                </p>
            </div>
        </div>
        ...
        <button 
            ref="startStopButton"
            class="
                w-full h-12 font-bold rounded-lg text-dark-400 text-md
