  ...
  <div class="h-screen w-screen relative">
    ...
    <qrcode-stream @init="onInit" v-if="!destroyed" @decode="onDecode" class="h-screen">
      <div class="flex justify-between items-center p-4">
        ...
        <!-- Number Input -->
        <div @click="handleNumberInputClick($event)" class="w-16 h-10 p-2 rounded-full bg-dark-400 flex justify-center items-center transition-transform-width duration-300 ease-out" v-bind:class = "(isNumberInputOpen)? 'w-44' :'w-16'">
          <input @keydown.enter="onEnter" v-model="numberInput" ref="numberInput" @focusin="focusIn" @focusout="focusOut" placeholder="Enter bike number" class="w-full h-full rounded-full px-4 bg-transparent" type="number" v-show="isNumberInputOpen">

          <svg class="h-4" v-show="!isNumberInputOpen" viewBox="0 0 473.4 289.7">
            <g transform="translate(-19.3 -210.4)">
              <path d="M19.3,236.6V473.9c0,14.5,12.4,26.2,27.7,26.2H465c15.3,0,27.7-11.8,27.7-26.2V236.6c0-14.5-12.4-26.2-27.7-26.2H47C31.7,210.4,19.3,222.1,19.3,236.6Zm448.9,0V473.9c0,.5-1.2,1.7-3.2,1.7H47c-2.1,0-3.2-1.2-3.2-1.7V236.6c0-.5,1.1-1.7,3.2-1.7H465C467,234.9,468.2,236.1,468.2,236.6Z"/>
              <circle cx="14.8" cy="14.8" r="14.8" transform="translate(90.1 277.8)"/>
              <path d="M165.3,307.4h0a14.8,14.8,0,1,0,0-29.6h0a14.8,14.8,0,1,0,0,29.6Z"/>
              <circle cx="14.8" cy="14.8" r="14.8" transform="translate(211 277.8)"/>
              <circle cx="14.8" cy="14.8" r="14.8" transform="translate(271.4 277.8)"/>
              <circle cx="14.8" cy="14.8" r="14.8" transform="translate(331.9 277.8)"/>
              <circle cx="14.8" cy="14.8" r="14.8" transform="translate(392.3 277.8)"/>
              <circle cx="14.8" cy="14.8" r="14.8" transform="translate(120.3 340.4)"/>
              <circle cx="14.8" cy="14.8" r="14.8" transform="translate(180.8 340.4)"/>
              <circle cx="14.8" cy="14.8" r="14.8" transform="translate(241.2 340.4)"/>
              <path d="M316.4,370h0a14.8,14.8,0,1,0,0-29.6h0a14.8,14.8,0,1,0,0,29.6Z"/>
              <circle cx="14.8" cy="14.8" r="14.8" transform="translate(362.1 340.4)"/>
              <path d="M138.3,417.9a12.291,12.291,0,0,0,12.3,12.3H361.4a12.3,12.3,0,0,0,0-24.6H150.6A12.291,12.291,0,0,0,138.3,417.9Z"/>
            </g>
          </svg>
        </div>
      </div>
