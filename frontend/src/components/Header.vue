...
<template>
    <div class="col-span-full flex items-center justify-center relative">
        <div @click="$router.back()" class="w-8 h-8 flex items-center justify-center">
            <svg class="w-4 h-4" viewBox="0 0 15.515 23.959">
        ...
        <h1 class="flex-grow text-center text-2xl font-bold text-dark-400"  v-if="$props.title != ''">{{ $props.title }}</h1>
